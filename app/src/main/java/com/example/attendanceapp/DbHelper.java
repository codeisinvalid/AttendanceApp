...
//    STATUS TABLE
    ...
    int deleteClass(long cid){
        SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
        return sqLiteDatabase.delete(CLASS_TABLE_NAME,
                C_ID+"=?",new String[]{String.valueOf(cid)});
    }
    ...
    long updateClass(long cid, String className, String subjectName){
        ...
        return sqLiteDatabase.update(CLASS_TABLE_NAME, values,
                C_ID+"=?",new String[]{String.valueOf(cid)});
    }
    ...
    int deleteStudent(long sid){
        SQLiteDatabase database = this.getReadableDatabase();
        return database.delete(STUDENT_TABLE_NAME, S_ID+"=?",
    ...
    long updateStudent(long sid, String name){
        ...
        return database.update(STUDENT_TABLE_NAME, values,S_ID+"=?",
                new String[]{String.valueOf(sid)});
    }
    ...
    String getStatus(long sid, String date){
        ...
        SQLiteDatabase database = this.getReadableDatabase();
        String whereClause = DATE_KEY +"='"+date+"' AND "+ S_ID+"="+sid;
        Cursor cursor = database.query(STATUS_TABLE_NAME, null, whereClause, null,
                null, null, null);
